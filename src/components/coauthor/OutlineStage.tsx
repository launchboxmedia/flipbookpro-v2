          ...
          <div className="bg-white border border-rose-200 rounded-2xl p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-cream-1 dark:bg-ink-1 hover:bg-cream-2 dark:hover:bg-ink-2 text-ink-1 dark:text-cream text-xs font-inter font-medium rounded-md transition-colors"
              >
          ...
          allChaptersAccepted ? (
            <div className="mb-4 rounded-lg border-l-4 border-emerald-400 bg-cream-3 dark:bg-ink-3 px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3">
              <div className="flex items-start gap-3 flex-1 min-w-0">
                ...
                <p className="font-source-serif text-sm text-ink-1 dark:text-cream-1">
            ...
            <div className="mb-4 rounded-lg border-l-4 border-gold bg-cream-3 dark:bg-ink-3 px-4 py-3 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-inter text-sm font-semibold text-ink-1 dark:text-cream-1">
                  Creator Radar suggested these chapters
                </p>
                <p className="font-source-serif text-xs text-ink-1/75 dark:text-cream-1/75 mt-0.5">
      ...
      <div className="md:col-span-2 min-w-0 space-y-4">
        ...
        <div className="bg-cream-2 dark:bg-ink-2 border border-cream-3 dark:border-ink-3 rounded-2xl overflow-hidden flex flex-col">
          ...
          <div className="flex items-center gap-2.5 px-6 py-4 border-b border-cream-3 dark:border-ink-3 bg-ink-1/10 dark:bg-ink-1/40">
            ...
            <h3 className="font-playfair text-ink-1 dark:text-cream text-lg font-semibold">AI Critique</h3>
          ...
          <div className="px-6 py-5 flex flex-col gap-4">
                ...
                {visibleFlags.map((flag) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-ink-1 dark:text-cream text-sm font-source-serif mb-1.5 leading-relaxed">
                        {flag.issue}
                      </p>
                      <p className="text-ink-1/60 dark:text-cream/60 text-xs font-source-serif italic mb-3 leading-relaxed">
                        {flag.suggestion}
                      </p>
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          disabled={applyingFlagIndex !== null}
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-[#E8E0D0] dark:bg-ink-4 hover:bg-cream-3 dark:hover:bg-ink-3 text-ink-subtle hover:text-ink-1 dark:hover:text-cream text-xs font-inter rounded-md transition-colors press-scale disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <X className="w-3 h-3" />
                          Dismiss
                        </button>
            ...
            <div className="flex flex-col gap-2 pt-2 border-t border-cream-3 dark:border-ink-3 -mx-6 px-6 -mb-5 pb-5 mt-1">
              <button
                onClick={runCritique}
                disabled={critiquing}
                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-cream-3 dark:bg-ink-3 hover:bg-[#E8E0D0] dark:hover:bg-ink-4 border border-[#E8E0D0] dark:border-ink-4 text-ink-1 dark:text-cream text-sm font-inter rounded-md transition-colors disabled:opacity-50 press-scale"
              >
                {critiquing ? (
                  <Loader2 className="w-3.5 h-3.5 animate-spin" />
                ) : hasCritiqued ? (
